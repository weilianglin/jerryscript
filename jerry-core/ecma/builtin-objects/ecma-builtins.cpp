                 ...
                 ecma_builtin_id_t builtin_id) /**< id of built-in to check on */
{
  ...
  ecma_builtin_id_t obj_builtin_id = (ecma_builtin_id_t) built_in_id_prop_p->u.internal_property.value;

  if (builtin_id == obj_builtin_id)
  {
    JERRY_ASSERT (ecma_builtin_objects[builtin_id] == obj_p);
